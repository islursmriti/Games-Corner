...
function drawStartScreen() {
  ...
  fillCenteredText("x key to shoot", CANVAS_WIDTH / 2, CANVAS_HEIGHT / 2, 500, '#FFFFFF', 36);
  fillCenteredText("left and right arrow key to move", CANVAS_WIDTH / 2, CANVAS_HEIGHT / 1.75, 500, '#FFFFFF', 36);
